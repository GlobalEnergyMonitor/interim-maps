var config = {
    ...
    geojson: 'https://publicgemdata.nyc3.cdn.digitaloceanspaces.com/refactor_testing/europe_map_2026-03-31.geojson',
    ...
    searchFields: {
        'Project': ['name', 'name-search', 'other-name', 'local-name', 'project-id'],
