var config = {
    ...
    tiles: ['https://publicgemdata.nyc3.cdn.digitaloceanspaces.com/Current_maps/integrated-power/2026-08-v3/tiles/{z}%5C{x}%5C{y}.pbf'],
    tileSourceLayer: 'integrated',

    /* name of the data file; use key `csv` if data file is CSV format, use key `geojson` if data file is geoJSON format */
    csv: 'https://publicgemdata.nyc3.cdn.digitaloceanspaces.com/Current_maps/integrated-power/2026-08-v3/integrated_map_2026-08-v3.csv',
