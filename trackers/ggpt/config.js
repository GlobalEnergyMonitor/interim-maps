var config = {
    ...
    geojson: 'https://publicgemdata.nyc3.cdn.digitaloceanspaces.com/interim_maps/ggpt_map_2026-03.geojson',
    ...
    searchFields: {
        'Plant': ['name', 'name-noneng', 'name-other'],
        'Companies': ['owner', 'operator', 'owner-noneng', 'operator-noneng'],
