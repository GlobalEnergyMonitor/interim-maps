var config = {
    ...
    geojson: 'https://publicgemdata.nyc3.cdn.digitaloceanspaces.com/refactor_testing/ggpt_map_2026-01-16.geojson',
    ...
    tableHeaders: {
        values: ['name', 'unit-name', 'capacity-display', 'tech-type', 'status', 'start-year', 'owner', 'operator', 'country-area1'],
