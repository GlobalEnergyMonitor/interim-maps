var config = {
    ...
    geojson: 'https://publicgemdata.nyc3.cdn.digitaloceanspaces.com/Current_maps/gist/gist_map_2026-09.geojson',
    ...
    searchFields: {
        'Plant': ['name', 'name-noneng'],
        'Companies': ['owner', 'parent', 'owner-noneng', 'parent-gem-id', 'owner-gem-id'],
